...
public class GeodeFilterRel extends Filter implements GeodeRel {
	...
	@Override public GeodeFilterRel copy(RelTraitSet traitSet, RelNode input,
			RexNode condition) {
	...
	@Override public void implement(GeodeImplementContext geodeImplementContext) {
		...
		geodeImplementContext.add(null, Collections.singletonList(match));
	}
