...
/**
 * Implementation of a {@link Filter} relational expression in Geode.
 */
public class GeodeFilterRel extends Filter implements GeodeRel {

  private String match;

  public GeodeFilterRel(RelOptCluster cluster, RelTraitSet traitSet, RelNode child, RexNode
      condition) {
  ...
  @Override public GeodeFilterRel copy(RelTraitSet traitSet, RelNode input, RexNode condition) {
    return new GeodeFilterRel(getCluster(), traitSet, input, condition);
  }
