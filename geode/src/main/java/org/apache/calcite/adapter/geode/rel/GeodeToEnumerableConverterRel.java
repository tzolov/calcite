 ...
 */
public class GeodeToEnumerableConverterRel extends ConverterImpl implements EnumerableRel {

  protected GeodeToEnumerableConverterRel(
  ...
  @Override public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
    return new GeodeToEnumerableConverterRel(
  ...
  /**
   * {@link GeodeTable.GeodeQueryable#query} method reference used in the {@link Expression}
   */
  private static final Method GEODE_QUERY_METHOD = Types.lookupMethod(
  ...
  @Override public Result implement(EnumerableRelImplementor implementor, Prefer pref) {
    ...
    // PhysType is Enumerable Adapter class that maps SQL types (getRowType) with physical Java
    // types (getJavaTypes())
    ...
    // Expression meta-program for calling the GeodeTable.GeodeQueryable#query method form the
    // generated code
    final BlockBuilder blockBuilder = new BlockBuilder().append(
        Expressions.call(
            ...
            // selected fields
            constantArrayList(toListMapPairs(geodeImplementContext.oqlAggregateFunctions), Pair
                .class),
...
// End GeodeToEnumerableConverterRel.java
