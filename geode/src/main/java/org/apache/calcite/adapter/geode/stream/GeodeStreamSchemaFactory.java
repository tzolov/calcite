...
public class GeodeStreamSchemaFactory implements SchemaFactory {
  ...
  public GeodeStreamSchemaFactory() {
    // Do Nothing
  }
  ...
  public synchronized Schema create(SchemaPlus parentSchema, String name,
    ...
    return new GeodeStreamSchema(locatorHost, locatorPort, regionNames,
        pbxSerializablePackagePath, parentSchema);
  }
}

// End GeodeStreamSchemaFactory.java
