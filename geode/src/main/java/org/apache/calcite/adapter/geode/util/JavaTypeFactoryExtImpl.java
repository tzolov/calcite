...
public class JavaTypeFactoryExtImpl
  ...
  /**
   * http://stackoverflow.com/questions/16966629/what-is-the-difference-between-getfields-and
  ...
  public RelDataType createPdxType(PdxInstance pdxInstance, boolean stream) {
    ...
    for (String fieldName : pdxInstance.getFieldNames()) {
      ...
      if (field == null) {
        ...
        // Map Nested PDX structures as String. This relates with GeodeUtils.convert case when
        // clazz is Null.
        fieldType = Map.class;
