...
public class JavaTypeFactoryExtImpl
  ...
  /**
   * http://stackoverflow.com/questions/16966629/what-is-the-difference-between-getfields-and-getdeclaredfields-in-java-reflectio
   */
  ...
  public RelDataType createPdxType(PdxInstance pdxInstance) {
    ...
    Class clazz = null;
    try {
      //TODO: (christian) Instead of PdxInstance Class we should use the actual class or we an run in type conflicts?
      clazz = Class.forName(pdxInstance.getClassName());
    } catch (ClassNotFoundException e) {
      e.printStackTrace();
    }
    return canonize(new JavaRecordType(list, clazz));
  }
}
